    ...
    <div className="space-y-8 animate-fade-in">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black text-text-primary">Purchase Returns</h1>
            <p className="text-text-secondary font-medium">History of goods returned to suppliers.</p>
          </div>
        </div>
        <button 
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-border bg-bg-secondary/30">
                  <th className="px-6 py-4 text-xs font-black text-text-muted uppercase tracking-widest">Return No / Supplier</th>
                  ...
                  filteredReturns.map((ret) => (
                    <tr key={ret.id} className="hover:bg-bg-secondary/50 transition-colors group animate-slide-up">
                      <td className="px-6 py-4">
                        ...
                        <span className="text-[10px] font-bold text-text-muted uppercase tracking-widest">{ret.supplierName}</span>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 text-right">
                        <button 
                          ...
                          title="View Details"
                          aria-label={`View details for return ${ret.returnNo}`}
                        >
