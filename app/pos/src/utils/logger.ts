...
class Logger {
  ...
  private formatLog(level: LogLevel, message: string, context?: Record<string, any>, error?: Error): LogData {
    return {
      message,
      level,
  ...
  public info(message: string, context?: Record<string, any>) {
    ...
    // Future: Push to Sentry/Logpush here
  }
  ...
  public async error(message: string, error?: Error | unknown, context?: Record<string, any>) {
