/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4384cfbe17193a8d185f0b53989bf2f4)
// Runtime types generated with workerd@1.20260504.1 2026-05-09 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SessionCoordinator" | "LocationStockCoordinator";
	}
	interface StagingEnv {
		...
		SESSION_COORDINATOR: DurableObjectNamespace<import("./src/index").SessionCoordinator>;
		STOCK_COORDINATOR: DurableObjectNamespace<import("./src/index").LocationStockCoordinator>;
		ORDER_WORKFLOW: Workflow<Parameters<import("./src/index").OrderProcessingWorkflow['run']>[0]['payload']>;
		REPORT_WORKFLOW: Workflow<Parameters<import("./src/index").MonthlyReportWorkflow['run']>[0]['payload']>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "JWT_SECRET" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_CHAT_ID" | "GOOGLE_GENERATIVE_AI_API_KEY" | "KBZ_APP_KEY" | "KBZ_MERCHANT_CODE" | "WAVE_MERCHANT_ID">> {}
}
